                            ...
                            <tr>
                                <td className="py-4">
                                    <div className="flex items-center">
                                        <Image className="h-[150px] w-[150px] mr-4 bg-[#eee] rounded-[8px]" src="/image/beras.png" alt="Product image" width={100} height={100}/>
                                        <span className="font-semibold text-[14px]">Product name</span>
                                    </div>
                                </td>
                                <td className="py-4 text-[14px]">$19.99</td>
